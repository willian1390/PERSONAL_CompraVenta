<?php
    class Proveedor extends Conectar{
        ...
        public function insert_proveedor($emp_id, $prov_nom, $prov_ruc, $prov_tel, $prov_direcc, $prov_correo){
            $conectar=parent::Conexion();
        ...
        public function update_proveedor($prov_id, $emp_id, $prov_nom, $prov_ruc, $prov_tel, $prov_direcc, $prov_correo){
            $conectar=parent::Conexion();
