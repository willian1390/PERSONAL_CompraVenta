<?php
    class Cliente extends Conectar{
        ...
        public function insert_cliente($emp_id, $cli_nom, $cli_ruc, $cli_tel, $cli_direcc, $cli_correo){
            $conectar=parent::Conexion();
            $sql="SP_I_CLIENTE_01 ?,?,?,?,?,?";
            $query=$conectar->prepare($sql);
            $query->bindValue(1,$emp_id);
        ...
        public function update_cliente($cli_id, $emp_id, $cli_nom, $cli_ruc, $cli_tel, $cli_direcc, $cli_correo){
            $conectar=parent::Conexion();
            $sql="SP_U_CLIENTE_01 ?,?,?,?,?,?,?";
            $query=$conectar->prepare($sql);
            $query->bindValue(1,$cli_id);
